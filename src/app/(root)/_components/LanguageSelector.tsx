  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="group relative flex items-center gap-3 px-4 py-2.5 bg-[#1e1e2e]/80 rounded-lg transition-all border border-gray-800/50 hover:border-gray-700"
      >
        ...
        <ChevronDownIcon className={`size-4 text-gray-400 transition-all duration-300 ${isOpen ? "rotate-180" : ""}`} />
      </motion.button>
